...
let socials = [
  ...
  { id: 4, icon_name: "i-simple-icons-x", link: "" },
];
let seconds = [
...
let thirds = ["Interest", "Programming", "Statistics", "Consulting"];

let states = [
  {
    id: 0,
    icon_name: "i-solar-laptop-bold-duotone",
    condition: "system",
  },
  {
    id: 1,
    icon_name: "i-solar-sun-2-bold-duotone",
    condition: "light",
  },
  {
    id: 3,
    icon_name: "i-solar-moon-stars-bold",
    condition: "dark",
  },
];
