      ...
      <template #wrapper="{ item }">
        <div class="flex flex-col-reverse sm:flex-row items-start justify-between gap-1 sm:gap-6 w-full">
          <div class="min-w-0 flex-1 space-y-0.5">
            <h3 class="text-base lg:text-lg font-bold text-zinc-900 dark:text-zinc-100">
              {{ item.title }}
          ...
          <span class="shrink-0 text-xs sm:text-sm font-medium text-teal-700 dark:text-teal-300 tabular-nums whitespace-nowrap sm:text-right pt-0.5">
